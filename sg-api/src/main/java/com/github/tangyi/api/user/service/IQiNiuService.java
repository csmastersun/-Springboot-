...
public interface IQiNiuService {
  ...
  Attachment upload(MultipartFile file, String groupCode, String user, String tenantCode)
      throws IOException;
  ...
  Long getDefaultCourseImage();

  Long getDefaultExamImage();

  Long getDefaultUserImage();
}
